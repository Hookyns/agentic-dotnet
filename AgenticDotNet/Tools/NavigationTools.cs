...
[McpServerToolType]
internal sealed class NavigationTools(WorkspaceService workspace)
{
	// ── Projects ───────────────────────────────────────────────────────────

	[McpServerTool(Name = "get_solution_projects")]
	[Description("List all projects in the solution with their paths, assembly names, and output kind.")]
	...
	public async Task<string> GetProjectNamespaces(
		[Description("Project name as it appears in the solution (use get_solution_projects to find names).")]
			string projectName,
